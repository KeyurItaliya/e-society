								...
								<table width="100%" bgcolor="#f8f8f8" border="0" cellspacing="0" cellpadding="0"
									...
									<tr>
										<td
											...
											<font face="'Open Sans', sans-serif">Dear Member </font>
										</td>
									</tr>
									<tr>
										<td
									...
									<td
										style="font:18px;font-family: 'Open Sans'; color:#292929; padding:0 5% 10px 5%;line-height: 25px;float: left;font-weight: 700">
										<font face="'Open Sans', sans-serif">Your Notice Title : <?php echo $notice_title; ?></font>
									</td>
                                    </tr>
                                    <tr>
									<td
										style="font:18px;font-family: 'Open Sans'; color:#292929; padding:0 5% 10px 5%;line-height: 25px;float: left;font-weight: 700">
										<font face="'Open Sans', sans-serif">Your Notice Description : <?php echo $notice_description; ?></font>
									</td>
									</tr>
									<tr>
										<td
