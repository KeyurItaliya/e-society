						...
						<tr>
							<td>
								<table width="100%" bgcolor="#f8f8f8" border="0" cellspacing="0" cellpadding="0"
									...
									<tr>
										<td><img editable src="images/colors-1596915_960_720.webp" width="143" height="140"
												label="Picture"></td>
									</tr>
									<tr>
										<td height="30">&nbsp;</td>
									...
									<tr>
										<td class="heading"
											...
											<singleline>Confirmation Email</singleline>
										</td>
									</tr>
									<tr>
										<td height="30">&nbsp;</td>
									...
									<tr>
										<td
											...
											<font face="'Open Sans', sans-serif">Dear new user, </font>
										</td>
									</tr>
									<tr>
										<td
											style="font:18px;font-family: 'Open Sans'; color:#292929; padding:0 5% 10px 5%;line-height: 25px;float: left;font-weight: 700">
											<font face="'Open Sans', sans-serif">Your User Name : <?php echo $to; ?></font>
										</td>
									</tr>
									<tr>
									<td
										style="font:18px;font-family: 'Open Sans'; color:#292929; padding:0 5% 10px 5%;line-height: 25px;float: left;font-weight: 700">
										<font face="'Open Sans', sans-serif">Your Password : <?php echo $get_password; ?></font>
									</td>
									</tr>
									<tr>
										<td
											style="font:18px;font-family: 'Open Sans'; color:#292929; padding:0 5% 10px 5%;line-height: 25px;text-align: left;">
											<font face="'Open Sans', sans-serif">You are almost ready to join with us.
											</font>
										</td>
									</tr>
									<tr>
										<td
											style="font:18px;font-family: 'Open Sans'; color:#292929; padding:0 5% 10px 5%;line-height: 25px;text-align: left;">
											<font face="'Open Sans', sans-serif">Simply click the big red button below to login your id.</font>
										</td>
									</tr>
									<tr>
										<td height="30">&nbsp;</td>
											...
											<table width="190" align="center" border="0" cellspacing="0" cellpadding="0"
												...
												<tr>
													<td align="center" bgcolor="#e02e4c" style="border-radius:28px;"
														height="61">
														<multiline><a href="<?php echo $varification_link; ?>"
																style="font:700 16px/61px 'Montserrat', Helvetica, Arial, sans-serif; color:#ffffff; text-decoration:none; display:block; overflow:hidden; outline:none;">Login
																Here </a></multiline>
													</td>
												</tr>
											</table>
													...
													<table width="100%" border="0" cellspacing="0" cellpadding="0"
														...
														<tr>
															<td align="center"
																...
																<singleline>&copy; 2020, All rights reserved
																</singleline>
															</td>
														</tr>
														<tr>
